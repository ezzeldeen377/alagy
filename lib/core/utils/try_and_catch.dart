...
Future<Either<Failure, T>> executeTryAndCatchForRepository<T>(
  ...
  try {
    ...
    return left(Failure(GlobalL10n.instance.tryCatchNetworkError));
    ...
    switch (e.code) {
      ...
      case 'user-not-found':
        return left(Failure(GlobalL10n.instance.tryCatchUserNotFound));
      case 'wrong-password':
      ...
      case 'operation-not-allowed':
        return left(Failure(GlobalL10n.instance.tryCatchOperationNotAllowed));
      case 'requires-recent-login':
        return left(Failure(GlobalL10n.instance.tryCatchRequiresRecentLogin));
      default:
        return left(Failure(GlobalL10n.instance.tryCatchAuthFailed));
    }
  } on TimeoutException {
    return left(Failure(GlobalL10n.instance.tryCatchRequestTimeout));
  } on SocketException {
    return left(Failure(GlobalL10n.instance.tryCatchNetworkError));
  } on FormatException {
    ...
    return left(Failure(GlobalL10n.instance.tryCatchServiceUnavailable));
  } catch (e) {
    ...
    return left(
        Failure(GlobalL10n.instance.tryCatchGenericError + e.toString()));
  }
}
...
Future<T> executeTryAndCatchForDataLayer<T>(Future<T> Function() action) async {
  try {
    ...
    switch (e.code) {
      case 'invalid-credential':
        throw FirebaseAuthException(
            message: GlobalL10n.instance.tryCatchInvalidCredential,
            code: e.code);
      case 'weak-password':
        throw FirebaseAuthException(
      ...
      case 'user-not-found':
        throw FirebaseAuthException(
            message: GlobalL10n.instance.tryCatchUserNotFound, code: e.code);
      case 'user-disabled':
        throw FirebaseAuthException(
    ...
    print('######################${e.toString()}');
    throw Exception(GlobalL10n.instance.tryCatchGenericError + e.toString());
  }
}
