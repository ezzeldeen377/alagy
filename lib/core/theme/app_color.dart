...
class AppColor {
  ...
  static const Color lgGreyColor = Color(0xFFE0E0E0);
  static const Color grayColor = Color(0xFF9E9E9E);
  static const Color blueColor = Color.fromARGB(255, 74, 35, 248);
  static const Color greenColor = Color(0xFF4CAF50);
  static const Color ofWhiteColor = Color(0xFFF5F5F5);
