...
import 'package:alagy/core/helpers/navigator.dart'; // Added
import 'package:alagy/core/helpers/spacer.dart';
import 'package:alagy/core/routes/routes.dart'; // Added
...
class SignUpScreen extends StatefulWidget {
  final bool canClose;
  const SignUpScreen({super.key, this.canClose = false});
...
class SignUpScreenState extends State<SignUpScreen>
  ...
  void initState() {
    ...
    _tabController.addListener(() {
      setState(() {
        selectedRole =
            _tabController.index == 0 ? Role.patient.name : Role.doctor.name;
      });
    });
  }
