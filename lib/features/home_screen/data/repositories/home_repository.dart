...
abstract class HomeRepository {
  ...
  Future<Either<Failure, List<DoctorAppointment>>> getReservations(String userId);
...
Stream<Either<Failure, List<String>>> getAllFavouriteDoctorId(String userId) {
  ...
  Future<Either<Failure, List<DoctorAppointment>>> getReservations(String userId) {
    return executeTryAndCatchForRepository(() async {
      final response=await dataSource.getReservation(userId);
      return response.map((element)=>DoctorAppointment.fromMap(element)).toList();
    });
  }
