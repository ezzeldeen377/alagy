...
class AddDoctorCubit extends Cubit<AddDoctorState> {
  ...
  final TextEditingController consultationFeeController =
      TextEditingController();
  final TextEditingController returningFeesController = TextEditingController();
  ...
  Future<void> close() {
    ...
    returningFeesController.dispose();
  ...
  DoctorModel prepareDoctorData() {
    ...
    return doctor!.copyWith(
        ...
        nameLower: nameController.text.isEmpty
            ? null
        ...
        returningFees: returningFeesController.text.isEmpty
            ? null
            : double.tryParse(returningFeesController.text),
        profileImage:state.profilePictureUrl,
        //  state.profilePictureUrl?.isNotEmpty == true
        ...
        uid: doctor.uid,
        type: doctor.type,
        addressLower: addressController.text.isEmpty
            ? null
