...
import 'package:alagy/features/doctor_details/presentation/widgets/bio_text_field.dart';
import 'package:alagy/features/doctor_details/presentation/widgets/custom_add_doctor_bloc_listener.dart';
import 'package:alagy/features/doctor_details/presentation/widgets/custom_dropdown_field.dart';
import 'package:alagy/features/doctor_details/presentation/widgets/custom_profile_picture.dart';
import 'package:alagy/features/doctor_details/presentation/widgets/custom_text_field.dart';
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                CustomContainer(
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomTextField(
                        controller: cubit.returningFeesController,
                        label: context.l10n.editDoctorReturningFee,
                        icon: Icons.attach_money,
                        keyboardType: const TextInputType.numberWithOptions(
                            decimal: true),
                        validator: numbersValidator,
                ...
                TextButton(
                    onPressed: () {
                      context.pushNamedAndRemoveAll(RouteNames.doctorHome);
                    },
                    child: Text(
