    ...
    try {
      ...
      if (permission == LocationPermission.denied) {
        ...
        if (permission == LocationPermission.denied) {
          ...
          showSnackBar(context, context.l10n.locationPermissionDenied,
      ...
      if (permission == LocationPermission.deniedForever) {
        ...
        showSnackBar(context, context.l10n.locationPermissionPermanentlyDenied);
        if (!mounted) return;
        setState(() => _isLoading = false);
        return;
      }
      ...
      if (!mounted) return;
      setState(() => _isLoading = false);
      showSnackBar(context, context.l10n.locationError(e.toString()),
          backgroundColor: Colors.red);
    }
  }
            ...
            markers: _selectedLatLng != null
                ? {
                    Marker(
                      ...
                      infoWindow:
                          InfoWindow(title: context.l10n.selectedLocationTitle),
                    ),
                  }
                : {},
